...
<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-lg-2 col-md-2 col-sm-2 col-xs-12"><span class="glyphicon glyphicon-plus"></span>Tambah Barang</button>
<br/>
<br/>
