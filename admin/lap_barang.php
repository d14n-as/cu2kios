...
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'MHSW CREATIVE',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0038XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. Surya Kencana, Pamulang',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'website : www.unpam.ac.id | email : admin@unpam.ac.id',0,'L');
