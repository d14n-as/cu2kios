...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 04, 2017 at 07:24 AM
...
--
CREATE DATABASE IF NOT EXISTS `malasngoding_kios` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
...
(8, 'Abdul', 'b', 'IMG-20160629-WA0063.jpg'),
(9, 'luli', 'luli', 'IMG-20160629-WA0063.jpg'),
(12, 'admin', 'admin', '');
...
(33, 'Ice Juice', 'Minuman', 'Pt Berkah Jaya', 1000, 1500, 50, 100);
...
(63, '2016-01-22', 'tic tac', 8, 40000, 32000, 16000),
(67, '2017-10-03', 'magnum', 10, 13000, 130000, 10000),
(68, '2017-10-29', 'Ice Juice', 50, 1500, 75000, 25000);
